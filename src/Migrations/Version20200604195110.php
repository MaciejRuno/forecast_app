 ...
 */
final class Version20200604195110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE api_data (id INT AUTO_INCREMENT NOT NULL, request_id INT DEFAULT NULL, temperature DOUBLE PRECISION NOT NULL, wind DOUBLE PRECISION NOT NULL, humidity DOUBLE PRECISION NOT NULL, rainfall_chance DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_8C048590427EB8A5 (request_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
